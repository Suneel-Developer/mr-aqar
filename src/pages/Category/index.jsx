...
const Category = () => {
    ...
    const handleScrollToBottom = () => {
        if (bottomDivRef.current) {
            bottomDivRef.current.scrollIntoView({ behavior: 'smooth', block: 'start' });
        }
    };
    ...
    return (
        <main>
            ...
            <section className="relative z-0 bo-px-page pt-5 md:pt-10 min-h-[calc(100lvh-80px)] px-4">
                ...
                <div className="sm:max-w-96 sm:mx-auto pb-28 relative">
                    ...
                    <div className="flex flex-col gap-4 max-w-[384px] mx-auto w-full">
                        ...
                        <button
                            className="text-base shrink-0 inline-flex items-center justify-center mt-2 select-none whitespace-nowrap transition-colors h-12 px-8 font-bold bg-[#3a7bb7] text-white w-full rounded-full"
            ...
            <section className="px-4 py-10 bg-[#f5f7f9]" ref={bottomDivRef}>
