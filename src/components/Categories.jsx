                ...
                <div>
                    <ul className='grid grid-cols-3 gap-2 md:gap-4'>
                        {categoriesdata.map((categry) => (
                            <li onClick={(() => navigate('/category'))} className='cursor-pointer p-4 bg-white shadow-2 flex flex-col justify-center items-center rounded-md gap-2'>
                                <img src={categry.logo} alt={categry.categoryname} className='h-10 md:h-14 w-auto object-cover' />
